...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "'--enable-shared' '--with-lto' '--with-dbmliborder=bdb' "
                "'ac_cv_buggy_getaddrinfo=no' 'ac_cv_file__dev_ptc=no' "
                "'ac_cv_file__dev_ptmx=no' 'ac_cv_working_tzset=yes' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.8.20/coverage.info',
 'COVERAGE_REPORT': '/build/Python-3.8.20/lcov-report',
 ...
 'LIBPL': '/install/lib/python3.8/config-3.8-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MODLIBS': '-lbz2          -lffi -ldl  -lm  -lncursesw  -lpanelw -lncursesw   '
            ...
            '-lsqlite3  -lssl -lcrypto     -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau  '
            '-luuid     -lm    -lm     -lexpat  -ledit -lncursesw         -lz',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.8.20 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.8.20/`cat pybuilddir.txt`:)./Lib '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.8.20',
 'SCRIPTDIR': '/install/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHAREDMODS': 'Modules/_crypt.cpython-38-aarch64-linux-gnu.so',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.8.20 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.8.20 ./python '
 ...
 'abs_builddir': '/build/Python-3.8.20',
 'abs_srcdir': '/build/Python-3.8.20',
